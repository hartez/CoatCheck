...
";
		...
		{
			var name = StationData.Parse(SampleData).location_name;
	...
	{
		[Theory]
		[InlineData("clear-day")]
		[InlineData("clear-night")]
		[InlineData("cloudy")]
		[InlineData("rainy")]
		[InlineData("snow")]
		[InlineData("thunderstorm")]
		[InlineData("partly-cloudy-day")]
		[InlineData("sleet")]
		[InlineData("rainy-day")]
		[InlineData("rainy-night")]
		[InlineData("sleet-day")]
		[InlineData("sleet-night")]
		[InlineData("partly-cloudy-night")]
		[InlineData("windy")]
		[InlineData("foggy")]
		[InlineData("snow-day")]
		[InlineData("snow-night")]
		[InlineData("thunderstorm-day")]
		[InlineData("thunderstorm-night")]
		public void LoadingSamllConditionsIconDoesNotThrow(string icon)
		{
			_ = ConditionsIconHelpers.GetConditionIconSmall(icon, Meadow.Color.Red);
		}
		...
		[InlineData("thunderstorm-day")]
		[InlineData("thunderstorm-night")]
        public void LoadingLargeConditionsIconDoesNotThrow(string icon)
		{
			_ = ConditionsIconHelpers.GetConditionIconLarge(icon, Meadow.Color.Red);
		}
	}
}